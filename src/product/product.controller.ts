import { Controller, Get, Post, Put, Delete, Body, Param, UsePipes, UseGuards, UseInterceptors, UploadedFile, Session } from '@nestjs/common';
...
async updateProduct(
  ...
  const adminUsername = session.username;
  return this.productService.updateProduct(pid, productUpdateInfo, adminUsername);
}
}
